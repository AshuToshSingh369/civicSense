    ...
    <div className="min-h-screen bg-stone-50 font-sans text-gray-900 leading-relaxed selection:bg-amber-200 selection:text-amber-900 bg-noise">
      ...
      <main>
        <section className="relative pt-12 pb-24 lg:pt-24 lg:pb-32 overflow-hidden">
          ...
          <div className="absolute top-0 right-0 w-[60%] h-full bg-blue-50 z-0 rounded-bl-[100px] opacity-60"></div>
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10 grid lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 pt-8">
              <div className="inline-block bg-amber-100 border border-amber-200 rounded-full px-4 py-1.5 mb-8 animate-fade-in">
              ...
              <h1 className="text-6xl lg:text-7xl font-bold text-gray-900 leading-[1.05] tracking-tight mb-8 font-serif">
                A Better City <br />
                Starts With <span className="text-blue-800 relative inline-block">
                  You.
                  <img src="/nepal_topographic_subtle_1769869685849.png" className="absolute bottom-0 left-0 w-full h-3 opacity-20" />
                </span>
              </h1>
            ...
            <div className="lg:col-span-5 relative h-[600px] hidden lg:block">
              ...
              <div className="absolute bottom-20 left-0 w-72 bg-white p-6 rounded-xl shadow-[0_20px_50px_rgba(0,0,0,0.15)] border-t-4 border-amber-500 animate-slide-up-fade">
        ...
        <section className="py-24 max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { t: "Road Maintenance", d: "Potholes, broken pavement, footpath damage.", i: "🛣️" },
              { t: "Waste Management", d: "Uncollected garbage, street litter, dumping.", i: "🚛" },
              { t: "Water Utility", d: "Pipe leakage, shortage, contaminated water.", i: "🚰" },
              { t: "Street Lighting", d: "Broken lamps, dark zones, electrical hazards.", i: "💡" },
              { t: "Public Sanitation", d: "Blocked drains, sewage overflow, river safety.", i: "💧" },
              { t: "Cultural Sites", d: "Temple maintenance, vandalism, encroachments.", i: "️🏛️" },
            ].map((item, i) => (
              <div key={i} className="card-official p-8 group hover:-translate-y-2 transition-transform duration-300">
                <div className="w-14 h-14 bg-stone-100 rounded-xl flex items-center justify-center text-3xl mb-6 group-hover:bg-blue-100 group-hover:scale-110 transition-all">{item.i}</div>
                <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-blue-800 transition-colors">{item.t}</h3>
